...
const Banner = () => {
    return (
        <div class="hero min-h-screen bg-primary  text-white">
            <div class="flex flex-col-reverse lg:flex-row-reverse gap-20 w-[60%]">
                <div class="text-center lg:text-left flex-1 mt-10">
                ...
                <div class="flex-1 w-full max-w-sm  bg-base-100">
